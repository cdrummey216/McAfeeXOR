...
public class Program
{
    ...
    public static void Coalesce(ref string a, ref string b, ref string c, int n)
    {
	...
	if (directiion == "up") { 
		Console.WriteLine("Encoding Initial Values.");
		count = 1;
	}
	else {
		Console.WriteLine("Decoding Initial Values.");
		count = 2;
	}
